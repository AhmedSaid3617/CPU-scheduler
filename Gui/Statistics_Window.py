...
class StatisticsWindow(tk.Toplevel):
    ...
    def setup_styles(self):
        ...
        style.configure("Statistics.Card.TFrame", background="#ffffff", relief="raised", borderwidth=1)
    ...
    def setup_ui(self):
        ...
        # Container frame
        container = ttk.Frame(self, style="Statistics.Card.TFrame", padding=20)
        ...
        # Title
        title_label = ttk.Label(container, text="Statistics", style="Statistics.Title.TLabel")
        ...
        for i in range(3):
            label = ttk.Label(container, text=labels[i], style="Statistics.TLabel", anchor="w")
            label.grid(row=i+1, column=0, sticky="nsew", padx=(10, 5), pady=5)

            value = ttk.Label(container, text=f"{values[i]:.2f} sec", style="Statistics.Value.TLabel", anchor="e")
